...
namespace WhatTheFuck.classes.websocket
{
    ...
    /// </summary>
    public partial class websocket_client
    {
        ...
        private websocket_server _websocketServer;
        ...
        /// <param name="websocketServer">The server object instance that the client is connected to</param>
        /// <param name="Socket">The socket of the connected client</param>
        public websocket_client(websocket_server websocketServer, Socket Socket)
        {
        ...
        public websocket_server GetServer()
        {
